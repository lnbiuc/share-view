        ...
        <div class="flex flex-col">
            ...
            >
                ...
                <el-form-item label="Category" prop="categoryId">
                    <el-select v-model="params.categoryId" clearable placeholder="Select Category" style="width: 100%">
                ...
                <el-form-item label="Preview Image" class="mt-6">
                    <div class="flex flex-row w-full">
                        ...
                        >
                            <div class="el-upload__text">Upload Preview Image <em>click to upload</em></div>
                        </el-upload>
                    </div>
                </el-form-item>
                ...
                <el-form-item label="Video">
                    <div class="flex flex-row w-full">
                        ...
                        >
                            <div class="el-upload__text">Upload Videos <em>click to upload</em></div>
                        </el-upload>
