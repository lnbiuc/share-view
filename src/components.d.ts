...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    ...
    IEpKeyboardDoubleArrowDown: typeof import('~icons/ep/keyboard-double-arrow-down')['default']
    ...
    IMaterialSymbolsStarRateRounded: typeof import('~icons/material-symbols/star-rate-rounded')['default']
